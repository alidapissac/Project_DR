...
image_dataset = load_image_files("dataset_grading/")

#Split data
X_train, X_test, y_train, y_test = train_test_split(image_dataset.data, image_dataset.target, test_size=0.10)
...
import pickle
pickle.dump(sclf, open('stack_model_grade.sav', 'wb'))
